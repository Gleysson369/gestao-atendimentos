...
public class CadastroAtendimentosController {
    ...
    // ALTERAÇÃO AQUI: @PreAuthorize REMOVIDO para permitir que qualquer usuário autenticado salve
    @PostMapping("/salvar")
    ...
    // ALTERAÇÃO AQUI: @PreAuthorize REMOVIDO para permitir que qualquer usuário autenticado edite
    ...
    // Deleta um atendimento - AINDA PROTEGIDO APENAS PARA ADMIN
    @PostMapping("/deletar/{id}")
    @PreAuthorize("hasAuthority('ADMIN')") // Apenas ADMIN pode deletar atendimentos
